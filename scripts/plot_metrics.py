...
# -------- 3: Staleness P50, p90, P100 per week --------
...
plt.plot(stale_df.index, stale_df["p90"], label="p90")
...
# -------- 4: Response Time P50, p90, P100 per week --------
...
plt.plot(resp_df.index, resp_df["p90"], label="p90")
